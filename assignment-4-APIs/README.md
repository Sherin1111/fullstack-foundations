...
with `"scripts": {"start": "node index.js"`
Then run `npm start`
...
Create a .env file and add your MySQL password
**password: "Your mySQL password"**
Make sure .env is listed in your .gitignore file to protect your password.
...
![Testing GET](image-2.png)

### Testing PUT

Order Cancelled
![Testing PUT Order Cancelled](image-3.png)

Order Fulfilled
![Testing PUT Order Fulfilled](image-4.png)

Order Processing
![Testing PUT Order Processing](image-5.png)
